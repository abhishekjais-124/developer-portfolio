        ...
        <div className="lg:mt-[52px]">
          <div className="relative rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-5 sm:p-7 lg:p-8 shadow-[0_20px_70px_rgba(0,0,0,0.35)] overflow-hidden">
            ...
            <div className="relative flex flex-col gap-6">
              <div>
                <p className="text-sm uppercase tracking-[0.18em] text-white/70">Direct lines</p>
              <h3 className="text-2xl font-semibold text-white mt-2">Reach out anytime</h3>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 px-4 py-3">
                <div className="h-11 w-11 rounded-lg bg-gradient-to-br from-[#16f2b3]/30 to-[#6a5af9]/30 border border-white/10 flex items-center justify-center text-white">
                  <MdAlternateEmail size={22} />
                </div>
                <div>
                  <p className="text-xs uppercase tracking-[0.14em] text-white/60">Email</p>
                  <p className="text-sm font-semibold text-white break-all">{personalData.email}</p>
                </div>
              </div>

              <div className="flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 px-4 py-3">
                <div className="h-11 w-11 rounded-lg bg-gradient-to-br from-[#f472b6]/30 to-[#6a5af9]/30 border border-white/10 flex items-center justify-center text-white">
                  <IoMdCall size={22} />
                </div>
                <div>
                  <p className="text-xs uppercase tracking-[0.14em] text-white/60">Phone</p>
                  <p className="text-sm font-semibold text-white">{personalData.phone}</p>
                </div>
              </div>

              <div className="flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 px-4 py-3 sm:col-span-2">
                <div className="h-11 w-11 rounded-lg bg-gradient-to-br from-[#16f2b3]/30 to-[#f472b6]/30 border border-white/10 flex items-center justify-center text-white">
                  <CiLocationOn size={22} />
                </div>
                <div>
                  <p className="text-xs uppercase tracking-[0.14em] text-white/60">Location</p>
                  <p className="text-sm font-semibold text-white">{personalData.address}</p>
                </div>
              </div>
            </div>
