        ...
        <div className="max-w-3xl text-white rounded-lg border border-[#464c6a] p-3 lg:p-5">
          ...
          <form onSubmit={handleSendMail} className="mt-6 flex flex-col gap-4">
              ...
              <div className="relative">
                <input
                  className={`bg-[#10172d] w-full border rounded-md ring-0 outline-0 transition-all duration-300 px-3 py-2 ${
                    errors.email ? 'border-red-500 focus:border-red-500' : 'border-[#353a52] focus:border-[#16f2b3]'
                  }`}
                  type="email"
                  maxLength="100"
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                className="bg-[#10172d] w-full border rounded-md border-[#353a52] focus:border-[#16f2b3] ring-0 outline-0 transition-all duration-300 px-3 py-2 resize-none"
                maxLength="500"
