              ...
              <div className="relative p-6 sm:p-7 rounded-xl bg-gradient-to-br from-[#0d1228]/60 via-[#0b1024]/60 to-[#0a0d1e]/60 backdrop-blur-sm border border-white/10 shadow-[0_10px_40px_rgba(0,0,0,0.35)] h-full flex flex-col gap-4 group overflow-hidden min-h-[420px]">
                ...
                <div className="relative z-10 flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-lg font-semibold text-white group-hover:text-pink-200 transition-colors">{item.title}</p>
                  </div>
                </div>

                <p className="relative z-10 text-sm text-[#cfd6e8] leading-relaxed flex-1">
                  {item.description}
                </p>

                <div className="relative z-10 flex items-center gap-2 text-xs text-[#e2e8ff] uppercase tracking-[0.16em] mt-auto pt-2 border-t border-white/5">
