export const experiences = [
  {
    ...
    highlights: [
      ...
      "Improved API performance by 35% and reduced server load by 20% via optimizations.",
      "Launched gamified rewards, boosting user retention by 25%.",
      "Maintained 99.98% uptime serving millions of users."
    ]
  },
  {
    id: 2,
    ...
    highlights: [
      ...
      "Designed scalable APIs and added Swagger for better collaboration."
    ]
  },
  {
    id: 3,
